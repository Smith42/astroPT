# this file will train a ~70m parameter model with the same hyperparams as
# EleutherAI's Pythia-70M (https://arxiv.org/abs/2304.01373)
#
...
eval_iters = 200
log_interval = 100
out_dir ='logs/astropt070M_entpatch'
