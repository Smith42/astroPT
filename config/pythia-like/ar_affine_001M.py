# Scaling-study run: AUTOREGRESSIVE objective, affine tokeniser, 001M model.
# Run (all runs use the unified loop):
#   python scripts/train.py config/pythia-like/ar_affine_001M.py
...
out_dir = "logs/pythia-like/ar_affine_001M"
