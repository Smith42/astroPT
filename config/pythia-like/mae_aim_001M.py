# Scaling-study run: BERT-style MAE objective, aim tokeniser, 001M model.
# Run (all runs use the unified loop):
#   python scripts/train.py config/pythia-like/mae_aim_001M.py
...
out_dir = "logs/pythia-like/mae_aim_001M"
