# Scaling-study run: AUTOREGRESSIVE objective, aim tokeniser, 021M model.
# Run (all runs use the unified loop):
#   python scripts/train.py config/pythia-like/ar_aim_021M.py
...
out_dir = "logs/pythia-like/ar_aim_021M"
