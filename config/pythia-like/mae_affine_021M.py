# Scaling-study run: BERT-style MAE objective, affine tokeniser, 021M model.
# Run (all runs use the unified loop):
#   python scripts/train.py config/pythia-like/mae_affine_021M.py
...
out_dir = "logs/pythia-like/mae_affine_021M"
